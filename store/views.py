...
def index(request):
    ...
    collections = allCollections.filter(Show_on_mainpage=True).prefetch_related('Products','Variants')
    ctt = []
...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(request,'Please keep your subject and query message short!')
